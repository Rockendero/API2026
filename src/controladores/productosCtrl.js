...
export const postInsertarProductos = async (req, res) => {
    try {
        ...
        const prod_imagen = req.file ? 'uploads/productos/' + req.file.filename : null
...
export const putProductos = async (req, res) => {
    try {
        const { id } = req.params
        const { prod_codigo, prod_nombre, prod_stock, prod_precio, prod_activo } = req.body
        const prod_imagen = req.file ? 'uploads/productos/' + req.file.filename : req.body.prod_imagen
